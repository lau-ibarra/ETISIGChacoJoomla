...
class PhocaDownloadCpModelPhocaDownloadLic extends JModelAdmin
{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_phocadownload.edit.phocadownloadlic.data', array());
