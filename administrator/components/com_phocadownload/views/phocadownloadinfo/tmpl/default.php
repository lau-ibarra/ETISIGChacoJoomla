...
echo '<div id="j-main-container" class="span9">'
	...
	.'<h3>'.JText::_($this->t['l'].'_PHOCA_DOWNLOAD').' - '. JText::_($this->t['l'].'_INFORMATION').'</h3>'
...
echo '<div style="margin-top:30px;height:39px;background: url(\''.JURI::base(true).'/media/com_'.$this->t['c'].'/images/line.png\') 100% 0 no-repeat;">&nbsp;</div>';
