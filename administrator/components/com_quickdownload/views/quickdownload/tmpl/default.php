...
<div class="span4">
		<div style="float:right;margin:10px;">
			<?php echo JHTML::_('image', 'administrator/components/com_quickdownload/assets/images/logo.png', 'beesto.com' );?>
		</div>
		...
		<p><?php echo '&copy ' . $extension['creationDate'] . ' ' . $extension['copyright'];?></p>

		<h3><?php echo  JText::_('COM_QUICKDOWNLOAD_LICENSE') ; ?></h3>
		<p>GNU/GPL</p>
		
		<h3><?php echo  JText::_('COM_QUICKDOWNLOAD_URL') ; ?></h3>
		<p><?php echo $extension['authorUrl'];?></p>
