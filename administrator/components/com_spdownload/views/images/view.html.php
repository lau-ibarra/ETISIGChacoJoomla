 ...
 * @since       1.0
 */
class SPDownloadViewImages extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        JHtml::_('script', 'com_spdownload/popup-imagemanager.js', true, true); //changed Panikos
        ...
        if (version_compare($joomla_version, $minimun_version, '<')) {
            if ($config->get('enable_flash', 1)) {
                ...
                JHtml::_('behavior.uploader', 'upload-flash', array(
