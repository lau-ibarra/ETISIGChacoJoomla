...
<form action="<?php echo htmlspecialchars($this->request_url); ?>" method="post" name="adminForm">
		<?php if ($this->t['type'] != 4) { ?>
	...
	<div id="editcell">
		<table class="adminlist">
			<thead>
				<tr>
					<th width="5px"><?php echo JText::_( 'COM_PHOCADOWNLOAD_NUM' ); ?></th>
					<th width="5px"></th>
					<th class="title" width="40%"><?php echo JHTML::_('grid.sort',  'COM_PHOCADOWNLOAD_TITLE', 'a.title', $this->lists['order_Dir'], $this->lists['order'] ); ?>
					</th>
...
<table class="admintable" width="100%">
	...
	<tr>
		<td>&nbsp;</td>
		<td align="right"><button onclick="insertLink();return false;"><?php echo JText::_( 'COM_PHOCADOWNLOAD_INSERT_CODE' ); ?></button></td>
	</tr>
</table>
</form>
...
<div style="text-align:right;margin:20px 5px;"><span class="icon-16-edb-back"><a style="text-decoration:underline" href="<?php echo $this->t['backlink'];?>"><?php echo JText::_('COM_PHOCADOWNLOAD_BACK')?></a></span></div>
</div>