		...
		<div id="carousel" class="favslider" <?php if ($controlnav == "false") {echo 'style="margin: 0!important;"';}?> >
			...
			<?php for ($i=1;$i<=10;$i++) { if (${'file'.$i} && ${'file'.$i.'active'} == 1 && ${'file'.$i} != " ") {?>
		    	<li style="margin-left: 3px;">
		    		<?php if (${'file'.$i.'link'}) { ?> <a href="<?php echo ${'file'.$i.'link'}; ?>" target="_<?php echo $target ?>"><img src="<?php echo ${'file'.$i}; ?>" /></a><?php } else { ?> <img src="<?php echo ${'file'.$i}; ?>" /> <?php } ?>
...
<?php } else { ?>
		...
		<div id="slider" class="favslider" <?php if ($slidertype == "slidernav") { ?>style="margin: 0!important;"<?php } ?>>
		    <ul class="favs">
			<?php for ($i=1;$i<=10;$i++) { if (${'file'.$i} && ${'file'.$i.'active'} == 1 && ${'file'.$i} != " ") {?>
