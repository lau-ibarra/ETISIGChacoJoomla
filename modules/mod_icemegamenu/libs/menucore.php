...
class IceMenuTree extends JTree
{
	...
	function toXML()
	{
		...
		{
			$this->_buffer .= '<div><div class="ice-megamenu-toggle"><a data-toggle="collapse" data-target=".nav-collapse">'.JText::_("ICE_MAIN_MENU").'</a></div><div class="nav-collapse icemegamenu collapse"><ul id="icemegamenu" class="meganizr mzr-slide mzr-responsive">';
