...
var DynamicColorPicker = new Class({
   ...
   Implements: [Options, Events],
    ...
    initialize: function(options) {
        ...
        DynamicColorPicker.autoLoad(this.options.pickerPath, function(pickerPath) {
...
DynamicColorPicker.auto = function(spec, options,path) {
    $$(spec).each(function(el) {
       var cp = new DynamicColorPicker($extend(options || {}, { textField: el, pickerPath:path}));
