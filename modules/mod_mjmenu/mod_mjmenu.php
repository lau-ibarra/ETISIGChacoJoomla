...
<base href="http://joomla30.joomlashine.com/">
...
if(isset($submenubgcolor)) {
	$document->addStyleDeclaration("
.mj-mainnav.navbar .nav > li ul.nav-child li a, .mj-mainnav.navbar .nav-collapse ul.nav li.active > ul.nav-child li a, .mj-mainnav.navbar .nav-collapse ul.nav li > ul.nav-child li a, .mj-mainnav.navbar .nav-collapse ul.nav li ul.nav-child li a, ul.nav-child li > ul.nav-child li a{background-color:$submenubgcolor;}
		");
}
