	...
	*/
    ...
    class JFormFieldPicker extends JFormField
    {
        ...
        protected function getInput() {
            ...
            return '<input type="text" name="' . $this->name . '" id="' . $this->id . '_picker" class="'.$this->name.' '.$className.' '. str_replace(array('[',']'),'_', $this->name) .' presetcolors" value="' . $this->value . '" size="10" /><span id="' . $this->id . '_picker" class="picker-box"></span>';
        }
    } 
