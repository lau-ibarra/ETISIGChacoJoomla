...
jQuery(function($){
	...
	$('#config-tab-content .controls .preset-contents').on('click', function(){
		$(this).closest('li').find('.presets').removeClass('active');
		$(this).parent().addClass('active');
		$('#presets-options .presetcolors').closest('li').hide();
		$('#presets-options').find('[class*="jform_params__'+$(this).data('preset')+'"]').closest('li').show();
	});

	$('#presets-options .presetcolors').closest('li').hide();
	$('#presets-options').find('[class*="jform_params__'+$current_preset+'"]').closest('li').show();
