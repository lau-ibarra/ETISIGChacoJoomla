...
class AvatarTemplate extends JObject {
	...
	public function setShowcase() 
	{
		...
		$this->_showcase = $_COOKIE[$this->_jtemplate->template.'-showcase'];
	}
	...
	public function addCSSCode()
	{
		...
		if (isset($_COOKIE[$this->_jtemplate->template. '-header-color']) && $_COOKIE[$this->_jtemplate->template. '-header-color'] != '') {
			$css .= 'h1, h2, h3, h4, h5, h6 {color:'.$_COOKIE[$this->_jtemplate->template. '-header-color'].';}'."\n";
		}
	 ...
	 */
	 ...
	 public function loadJquery() {
	 	$script = '<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js" type="text/javascript"></script><script type="text/javascript">jQuery.noConflict();</script>';
		return $script;
	 }
	...
	public function setBackground() 
	{
		...
		$this->_bgImage = JRequest::getVar($this->_jtemplate->template.'-background-image', '', 'COOKIE');
	}
}